      ...
      <div className="max-w-[1320px] mx-auto px-4 py-14">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-[#2a1008] mt-2">Pet CBD Dosage Calculator</h2>
            <p className="text-gray-500 text-sm mt-2">Enter your pet&apos;s weight for a recommended starting dosage.</p>
          </div>
              ...
              <div className="space-y-4 animate-[fadeSlideIn_0.3s_ease-out]">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-[#f5f0eb] rounded-xl p-4 text-center">
                    <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1">Low</p>
                    <p className="text-2xl font-bold text-[#3d2b1f]">{result.low}<span className="text-sm font-normal text-gray-400">mg</span></p>
                    <p className="text-[10px] text-gray-400 mt-1">Mild support</p>
                  </div>
                  <div className="bg-[#1A9248]/10 border-2 border-[#1A9248]/20 rounded-xl p-4 text-center">
                    <p className="text-[10px] font-bold uppercase tracking-wider text-[#1A9248] mb-1">Medium</p>
                    <p className="text-2xl font-bold text-[#1A9248]">{result.mid}<span className="text-sm font-normal text-[#1A9248]/60">mg</span></p>
                    <p className="text-[10px] text-[#1A9248]/70 mt-1">Recommended</p>
                  </div>
                  <div className="bg-[#f5f0eb] rounded-xl p-4 text-center">
                    <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1">High</p>
                    <p className="text-2xl font-bold text-[#3d2b1f]">{result.high}<span className="text-sm font-normal text-gray-400">mg</span></p>
                    <p className="text-[10px] text-gray-400 mt-1">Strong support</p>
                  </div>
                </div>
