...
export default function InstagramFeedClient({ posts }: { posts: Post[] }) {
    ...
    <>
      <section className="bg-[#2a1008] py-12 overflow-hidden">
        <div className="text-center mb-8">
          <p className="text-[#1A9248] text-[16.5px] font-bold uppercase tracking-[0.3em] mb-2">
            Let&apos;s Get Social
          </p>
          <Link
          ...
          >
            ...
            <div className="flex flex-col flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100">
                ...
                <div>
                  <p className="text-[16.5px] font-bold text-gray-900 leading-none">@hempandbarrel</p>
                  <p className="text-[16.5px] text-gray-400 mt-0.5">Hemp & Barrel</p>
                </div>
              </div>

              {/* Caption */}
              <div className="flex-1 overflow-y-auto px-5 py-4">
                <p className="text-[16.5px] text-gray-800 leading-relaxed whitespace-pre-line">
                  {activePost.caption}
                </p>
              </div>
              ...
              <div className="border-t border-gray-100 px-5 py-4 flex items-center justify-between">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-[15px] font-semibold text-gray-700 hover:text-[#d6249f] transition-colors"
                >
