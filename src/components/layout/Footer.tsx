          ...
          <div className="md:col-span-3">
            ...
            <div className="flex gap-3 mb-8">
              <Link href="https://www.facebook.com/HempandBarrel" target="_blank" rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-[#1A9248] hover:bg-[#148038] flex items-center justify-center transition-all hover:scale-110">
            ...
            <div className="space-y-2">
              {["Lab Tested Products", "Fast USA Shipping", "Secure Checkout"].map((badge) => (
                <div key={badge} className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-full bg-[#1A9248] flex items-center justify-center flex-shrink-0">
