      ...
      <section className="bg-[#3d2b1f] py-12">
        <div className="max-w-[1100px] mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {INFO_CARDS.map((card) => (
              <div key={card.label}
                className="bg-white/5 hover:bg-white/8 border border-white/10 rounded-2xl p-6 flex flex-col gap-4 transition-all duration-300 hover:border-[#1A9248]/40 group">
                <div className="w-11 h-11 bg-[#1A9248]/15 group-hover:bg-[#1A9248]/25 rounded-xl flex items-center justify-center text-[#1A9248] transition-colors">
                  {card.icon}
                </div>
                ...
                {card.action && (
                  <Link
                    ...
                    className="text-[#1A9248] hover:text-white text-xs font-bold uppercase tracking-wider transition-colors flex items-center gap-1.5 group/link"
                  >
                    {card.action.text}
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 p-8 md:p-10">
              ...
              {status === "sent" ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  <div className="w-20 h-20 bg-[#1A9248]/10 rounded-full flex items-center justify-center mb-6">
                    <svg className="w-10 h-10 text-[#1A9248]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="text-sm font-semibold text-[#1A9248] hover:underline"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-[#3d2b1f]/60 uppercase tracking-wider mb-2">
                        First Name <span className="text-[#1A9248]">*</span>
                      </label>
                      <input
                        type="text"
                        name="firstName"
                        ...
                        required
                        placeholder="Jane"
                        className="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-[#1A9248] focus:ring-2 focus:ring-[#1A9248]/10 outline-none text-[#3d2b1f] placeholder:text-gray-300 text-sm transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-[#3d2b1f]/60 uppercase tracking-wider mb-2">
                        Last Name <span className="text-[#1A9248]">*</span>
                      </label>
                      <input
                        type="text"
                        name="lastName"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#3d2b1f]/60 uppercase tracking-wider mb-2">
                      Email Address <span className="text-[#1A9248]">*</span>
                    </label>
                    <input
                      type="email"
                      name="email"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#3d2b1f]/60 uppercase tracking-wider mb-2">
                      Your Message <span className="text-[#1A9248]">*</span>
                    </label>
                    <textarea
                      name="message"
                      value={form.message}
                      ...
                      className="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-[#1A9248] focus:ring-2 focus:ring-[#1A9248]/10 outline-none text-[#3d2b1f] placeholder:text-gray-300 text-sm transition-all resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-[#1A9248] hover:bg-[#148038] disabled:opacity-70 text-white font-bold uppercase tracking-widest text-sm py-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#1A9248]/30 flex items-center justify-center gap-3"
                  >
                    {status === "sending" ? (
                      <>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded-3xl overflow-hidden shadow-xl shadow-gray-200/60 h-[360px] relative">
                ...
                <Link
                  ...
                  className="absolute bottom-4 right-4 bg-white hover:bg-[#1A9248] hover:text-white text-[#3d2b1f] text-xs font-bold uppercase tracking-wider px-4 py-2.5 rounded-full shadow-lg transition-all duration-300 flex items-center gap-2"
                >
              ...
              <div className="bg-[#2a1008] rounded-3xl p-7 flex flex-col sm:flex-row gap-6 items-center justify-between">
                ...
                <div className="flex gap-3">
                  <Link
                    ...
                    rel="noopener noreferrer"
                    aria-label="Facebook"
                    className="w-11 h-11 rounded-full bg-white/10 hover:bg-[#1A9248] flex items-center justify-center transition-all duration-300 hover:scale-110"
                  >
              ...
              {/* FAQ nudge */}
              <div className="border-2 border-dashed border-[#1A9248]/30 rounded-2xl p-6 flex items-center gap-5 hover:border-[#1A9248]/60 transition-colors">
                <div className="w-12 h-12 bg-[#1A9248]/10 rounded-xl flex items-center justify-center flex-shrink-0">
