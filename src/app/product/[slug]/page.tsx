  ...
  return (
    <>
      ...
      <div className="bg-[#fafaf8] border-b border-gray-100">
        <div className="w-full mx-auto px-[15px] py-3">
      ...
      {/* ── Product section ── */}
      <section className="w-full mx-auto px-[15px] py-10 md:py-14">
      ...
      {product.description && (
        <section className="bg-[#fafaf8] border-t border-gray-100">
          <div className="w-full mx-auto px-[15px] py-12">
      ...
      {/* ── Related products ── */}
      {related.length > 0 && (
        <section className="w-full mx-auto px-[15px] py-12">
