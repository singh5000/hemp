  ...
  return (
    <>
      ...
      <section className="relative bg-[#2a1008] overflow-hidden">
        ...
        <div className="relative w-full mx-auto px-[15px] py-20 md:py-28 text-center">
      ...
      {/* ── Origin Story ── */}
      <section className="w-full mx-auto px-[15px] py-20">
      ...
      {/* ── Quick Links ── */}
      <section className="w-full mx-auto px-[15px] py-16">
